...
internal enum L10n {
  ...
  internal enum About {
    ...
    internal enum Author {
      /// Developed by 
      internal static let developed = L10n.tr("Localizable", "about.author.developed")
      /// Eugene Lezov
      internal static let name = L10n.tr("Localizable", "about.author.name")
    }
  ...
  internal enum Donate {
    ...
    internal enum Help {
      /// Помочь деньгами
      internal static let money = L10n.tr("Localizable", "donate.help.money")
      /// или стать волонтером
      internal static let volunteer = L10n.tr("Localizable", "donate.help.volunteer")
    }
    ...
    internal enum Screen {
      /// Свыше 11 лет мы помогаем детям жить свободно от боли
      internal static let description = L10n.tr("Localizable", "donate.screen.description")
    }
